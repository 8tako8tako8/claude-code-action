...
## Fork Changes (8tako8tako8/claude-code-action@beta)
...
- **Updated Base Action**: Uses `8tako8tako8/claude-code-base-action@beta` which includes OAuth credential handling
